...
contract Withdrawal is Test {
    ...
    address constant public anotherWallet = 0xdeAD00000000000000000000000000000000dEAd;
    ...
    function testWithdrawal() public {
        ...
        bytes memory transfer_vega_to_another_wallet = abi.encodeWithSelector(vegaToken.transfer.selector, anotherWallet, totalVested);
